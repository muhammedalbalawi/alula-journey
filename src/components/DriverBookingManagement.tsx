  ...
  const fetchBookings = async () => {
    try {
      ...
      const transformedBookings = (data || []).map(booking => ({
        ...booking,
        tourist_name: booking.profiles?.full_name || 'Unknown',
        tourist_phone: booking.profiles?.contact_info || '',
        driver_name: booking.drivers?.name || '',
        driver_phone: booking.drivers?.phone || '',
        driver_car: booking.drivers ? `${booking.drivers.car_color} ${booking.drivers.car_model}` : '',
        driver_plate: booking.drivers?.plate_number || ''
      }));
