...
import { Heart, ChevronDown, ChevronUp, Edit2, Trash2, MessageCircle, MapPin, Calendar } from 'lucide-react';
...
export const TouristAlbum = () => {
  ...
  const texts = {
    title: isArabic ? 'لحظاتك' : 'Your Moments',
    ...
    viewMoments: isArabic ? 'عرض اللحظات' : 'View Moments',
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <Button
        ...
        variant="outline"
        className="w-full justify-between p-4 h-auto hover-scale"
      >
